...
public class PodgladArchiwum extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					PodgladArchiwum frame = new PodgladArchiwum(connection);
	 ...
	 * Create the frame.
	 */
	public PodgladArchiwum(final Connection connection) {
...
//						WylaczAlarm.setIcon(new ImageIcon(img3));
	...
	public void ShowTable(Connection connection, JTable table)
	{
		...
		try {
			String query="SELECT * FROM cardsarchive";
