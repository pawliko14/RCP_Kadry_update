...
public class PodgladTabeliKartZablokowanych extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					PodgladTabeliKartZablokowanych frame = new PodgladTabeliKartZablokowanych(connection);
	 ...
	 * Create the frame.
	 */
	public PodgladTabeliKartZablokowanych(final Connection connection) {
		
		setBackground(Color.WHITE);
		setTitle("Podgl\u0105d tabeli kart zablokowanych");
		...
		JLabel lblMojeMenu = new JLabel("Tabela kart zablokowanych");
