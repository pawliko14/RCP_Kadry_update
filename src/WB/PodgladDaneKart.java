...
public class PodgladDaneKart extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					PodgladDaneKart frame = new PodgladDaneKart(connection);
	 ...
	 * Create the frame.
	 */
	public PodgladDaneKart(final Connection connection) {
		
		setBackground(Color.WHITE);
		setTitle("Podgl\u0105d aktywnych kart");
		...
		JLabel lblMojeMenu = new JLabel("Tabela aktywnych kart");
